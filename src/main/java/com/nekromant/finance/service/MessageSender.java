...
public class MessageSender {
  ...
  public void sendMessage(String text, String chatId) {
    sendMessage(SendMessage.builder().text(text).chatId(chatId).build());
  }
  ...
  public void sendMessageWithInlineButtons(
      Long chatId, String messageText, List<InlineKeyboardButton> list, int rowNumbers)
